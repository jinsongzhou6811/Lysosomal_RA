...
for (gse in datasets) {
  ...
  pdf_path <- file.path(module_dir, gse, "Results_WGCNA_GO-KEGG-Reactome", 
                        paste0(gse, "_scale_free_topology_S2.pdf"))
  ...
  ggsave(pdf_path, combined, width = 14, height = 6, dpi = 350, bg = "white")
  
  cat("✅ Successfully generated:", basename(pdf_path), "\n")
}

cat("\n=== All scale-free topology PDFs have been successfully generated! ===\n")
