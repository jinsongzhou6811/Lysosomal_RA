...
config <- list(
  base_dir = data_dir,
  output_base_dir = file.path(module_dir, "03_UVMR_Combo_Weights"),
  exposure_ids_file = file.path(data_dir, "UVMR_exposure_Combo_Weights_ids.txt"), # Use absolute path
